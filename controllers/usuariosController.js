...
const configuracionMulter = {
    ...
    fileFilter(req, file, cb)  {
        if(file.mimetype === 'image/jpeg' || file.mimetype === 'image/png'){
            ...
            cb(new Error('Formato no vàlido'), false);
        }
    }
};
...
exports.validarRegistro = ( req, res, next ) => {
        ...
        req.checkBody('confirmar', 'El passwod es diferente').equals(req.body.password);
        ...
        // Si toda la validacion en correcta
        next();
